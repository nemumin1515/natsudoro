/*! qrcode 1.5.4 and dijkstrajs 1.0.3; MIT licenses: see THIRD_PARTY_LICENSES.txt */
(function (global) {
  'use strict';
  var modules = {
0: function(module, exports, __require) {

const canPromise = __require(1)

const QRCode = __require(2)
const CanvasRenderer = __require(25)
const SvgRenderer = __require(27)
...
const Utils = __require(3)
const ECLevel = __require(4)
const BitBuffer = __require(5)
const BitMatrix = __require(6)
const AlignmentPattern = __require(7)
const FinderPattern = __require(8)
const MaskPattern = __require(9)
const ECCode = __require(10)
const ReedSolomonEncoder = __require(11)
const Version = __require(14)
const FormatInfo = __require(18)
const Mode = __require(15)
const Segments = __require(19)
...
const getSymbolSize = __require(3).getSymbolSize
...
const ECLevel = __require(4)
const Mode = __require(15)
const VersionCheck = __require(16)
...
const Mode = __require(15)
const NumericData = __require(20)
const AlphanumericData = __require(21)
const ByteData = __require(22)
const KanjiData = __require(23)
const Regex = __require(17)
const Utils = __require(3)
const dijkstra = __require(24)
